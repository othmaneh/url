...
.breadcrumb{margin:20px 0 5px;}
  ...
  <b:if cond='data:blog.url == &quot;https://mylikss.blogspot.com/p/blog-page_23.html&quot;'>
<style type='text/css'>
...
var str = currentURL;
  var res = str.replace("https://mylikss.blogspot.com/p/blog-page_23.html?url=", "");
$(".Visit_Link").hide();
function changeLink(){
...
//<![CDATA[
  ...
  input.onkeyup = function() {
    if (input.value != "") {
      output.value = "https://mylikss.blogspot.com/p/blog-page_23.html?url=" + Base64.encode(this.value); //change with your link
    } else {
      output.value = "";
    }
  }
